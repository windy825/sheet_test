...
with tab0:
    ...
    end_month = pd.Timestamp(year=this_year, month=monthrange(this_year, this_month)[1])
...
with tab2:
    ...
    limit = st.number_input("대상 선수금 수", min_value=10, max_value=10000, value=200, step=10)
    if df_sunsu_f.empty or df_seon_f.empty:
